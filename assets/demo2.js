 ...
 */
{
	...
	const TiltObj = function(el, options) {
		...
		this.DOM = {};
		this.DOM.img = this.el.querySelector('.intro');
		this.DOM.title = this.el.querySelector('.blurb');
		this._initEvents();
	}
	...
	DOM.contentElems = Array.from(document.querySelectorAll('.intro'));
	DOM.contentLinks = Array.from(document.querySelectorAll('.blurb'));
	DOM.footer = document.querySelector('.intro');
	...
	const init = function() {
		imagesLoaded(document.body, () => {
			...
			Array.from(document.querySelectorAll('.intro')).forEach(el => new TiltObj(el));
